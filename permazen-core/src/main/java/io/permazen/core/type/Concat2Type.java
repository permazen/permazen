...
abstract class Concat2Type<T, S1, S2> extends BuiltinEncoding<T> {
    ...
    protected Concat2Type(Class<T> type, T defaultValue, Encoding<S1> type1, Encoding<S2> type2) {
       super(type, defaultValue);
       this.type1 = type1;
       this.type2 = type2;
    }

    protected Concat2Type(Class<T> type, Encoding<S1> type1, Encoding<S2> type2) {
