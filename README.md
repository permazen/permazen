...
The paper [JSimpleDB: Language-Natural Persistence for Java](https://cdn.rawgit.com/archiecobbs/jsimpledb/master/paper.pdf) describes the issues that are inherent to persistence programming and how JSimpleDB addresses them. Abstract:
