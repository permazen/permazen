...
public class SnapshotTest extends TestSupport {
    ...
    // Snapshot
        ...
        // Copy id1
        Assert.assertTrue(tx1.copy(id1, id1, tx2));
        ...
        Assert.assertTrue(tx1.copy(id3, id3, tx2));

        // Verify non-copy of id1 - already copied
        Assert.assertFalse(tx1.copy(id1, id1, tx2));
