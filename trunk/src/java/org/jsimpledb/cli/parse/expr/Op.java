...
// Array access
    ...
    ARRAY_ACCESS(2, "[]") {
        ...
        Value apply(Session session, final Value targetValue, final Value itemValue) {
...
// Unary
    ...
    UNARY_PLUS(1, "+") {
        @Override
        Value apply(Session session, Value value) {
...
// Multiplicative
    ...
    MULTIPLY(2, "*") {
        @Override
        Value apply(Session session, Value lhs, Value rhs) {
...
// Methods
     ...
     */
    public Value apply(Session session, Value... args) {
    ...
    Value apply(Session session, Value arg) {
        throw new UnsupportedOperationException();
    }

    Value apply(Session session, Value arg1, Value arg2) {
        throw new UnsupportedOperationException();
    }

    Value apply(Session session, Value arg1, Value arg2, Value arg3) {
        throw new UnsupportedOperationException();
    }
}
