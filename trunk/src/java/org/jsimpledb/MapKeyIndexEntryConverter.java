...
class MapKeyIndexEntryConverter<T, V, WV> extends Converter<MapKeyIndexEntry<T, V>, org.jsimpledb.core.MapKeyIndexEntry<WV>> {
    ...
    MapKeyIndexEntryConverter(ReferenceConverter<T> referenceConverter, Converter<V, WV> valueConverter) {
    ...
    protected org.jsimpledb.core.MapKeyIndexEntry<WV> doForward(MapKeyIndexEntry<T, V> entry) {
        if (entry == null)
            return null;
        return new org.jsimpledb.core.MapKeyIndexEntry<WV>(this.referenceConverter.convert(entry.getObject()),
    ...
    protected MapKeyIndexEntry<T, V> doBackward(org.jsimpledb.core.MapKeyIndexEntry<WV> entry) {
        if (entry == null)
            return null;
        return new MapKeyIndexEntry<T, V>(this.referenceConverter.reverse().convert(entry.getObjId()),
