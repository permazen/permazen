...
/**
 * Superclass for the {@link JClass}, {@link JField}, and {@link JCompositeIndex} classes
 * which describe the schema associated with a {@link Permazen} instance.
 */
public abstract class JSchemaItem {
...
// Constructor
    ...
    JSchemaItem(String name, int storageId, String description) {
...
// Package Methods
    ...
    final <T extends JSchemaItem> void visitSchemaItems(Class<T> nodeType, Consumer<? super T> visitor) {
