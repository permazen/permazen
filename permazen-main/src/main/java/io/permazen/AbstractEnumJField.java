 ...
 */
abstract class AbstractEnumJField<A, B> extends ConvertedJSimpleField<A, B> {

    final Class<? extends Enum<?>> enumType;

    AbstractEnumJField(String name, int storageId, TypeToken<A> typeToken, Encoding<B> encoding,
      Class<? extends Enum<?>> enumType, boolean indexed, io.permazen.annotation.JField annotation,
