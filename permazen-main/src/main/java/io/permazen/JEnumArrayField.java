 ...
 */
public class JEnumArrayField extends AbstractEnumJField<Object, Object> {
...
// Constructor
    ...
    JEnumArrayField(String name, int storageId, Class<? extends Enum<?>> enumType, Class<?> enumArrayEncoding,
