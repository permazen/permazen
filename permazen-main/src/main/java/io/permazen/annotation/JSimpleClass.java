...
/**
 * Java annotation for Java classes that are {@link io.permazen.JSimpleDB} object model types.
 *
 * <p>
 * Model classes may be POJO's, {@code abstract} classes, or interfaces, and the Java bean getter methods therein define database
 * fields; JSimpleDB generates concrete subclasses of each model class at runtime.
 ...
 * <ul>
 *  <li>{@link JField &#64;JField} - defines a simple value, reference, or {@link io.permazen.Counter} field
 ...
 *
 * <p>
 * These annotations are also supported on the methods in a {@link JSimpleClass &#64;JSimpleClass}-annotated class:
 *
 * <ul>
 ...
 *  <li>{@link FollowPath &#64;FollowPath} - annotates a method returning objects found by traversing a
 *      {@link io.permazen.ReferencePath}
 * </ul>
 *
 * <p>
 ...
 * and superinterfaces (whether or not annotated with {@link JSimpleClass &#64;JSimpleClass}).
 *
 * <p><b>{@link io.permazen.JObject} interface</b></p>
 *
 * <p>
 * The subclass of any {@link JSimpleClass &#64;JSimpleClass}-annotated model class that is generated by {@link io.permazen.JSimpleDB} will implement
 * {@link io.permazen.JObject}, so the (abstract) model classes may be declared that way.
 *
 * <p><b>Indexing</b></p>
 *
 * <p>
 ...
 *
 * <p>
 * Composite indexes are declared by annotating any supertype of a {@link JSimpleClass &#64;JSimpleClass}-annotated class
...
public @interface JSimpleClass {
     ...
     * @see io.permazen.StorageIdGenerator#generateClassStorageId StorageIdGenerator.generateClassStorageId()
     */
     ...
     * configured {@link io.permazen.StorageIdGenerator}.
     *
     * <p>
     ...
     * @see io.permazen.JSimpleDBFactory#setStorageIdGenerator JSimpleDBFactory.setStorageIdGenerator()
     */
