...
/**
 * Annotates Java methods that should return all objects found at the far end of a {@link ReferencePath}.
 *
 * <p>
 ...
 *
 * <p>
 * Annotating an abstract method with {@code @FollowPath("->some->path")} is equivalent to providing an implementation
 * that returns all objects reachable via the {@linkplain ReferencePath reference path} {@code "->some->path"} when
 * starting at the current instance. References can be traversed in either the forward or inverse directions; see
 * {@link ReferencePath} for details on reference paths.
 *
 * <p>
 * For example:
 * <pre>
 ...
 *       *&#47;
 *      <b>&#64;FollowPath("-&gt;parent-&gt;parent-&gt;parent&lt;-TreeNode.parent&lt;-TreeNode.parent")</b>
