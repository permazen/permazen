 ...
 */
public abstract class JField extends JSchemaItem {

    final Method getter;
    final Annotation annotation;

    JSchemaItem parent;                               // either JClass or JComplexField
    boolean requiresDefaultValidation;

// Constructor

    JField(String name, int storageId, Annotation annotation, String description, Method getter) {
...
// Public Methods
     ...
     * @throws IllegalArgumentException if {@code jobj} is null or has the wrong object type
     */
    public byte[] getKey(JObject jobj) {
        Preconditions.checkArgument(jobj != null, "null jobj");
        return this.getSchemaItem().getKey(jobj.getObjId());
    }
    ...
    /**
     * Get the {@link JClass} of which this field is a member.
     *
