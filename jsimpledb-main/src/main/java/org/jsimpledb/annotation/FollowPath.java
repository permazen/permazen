...
/**
 * Java annotation for declaring methods that should return objects found by traversing a {@link org.jsimpledb.ReferencePath}.
 *
 * <p>
 ...
 * that creates and traverses the {@linkplain org.jsimpledb.ReferencePath reference path} {@code "some.path"}.
 * See {@link org.jsimpledb.ReferencePath} for details on reference paths. The specified reference path is assumed to not
 * have any {@linkplain org.jsimpledb.ReferencePath#getTargetField target field}.
 *
 * <p>
