...
public enum Consistency {
     ...
     * {@link RetryTransactionException}s. Committing a transaction at this level is actually
     ...
     * result in {@link RetryTransactionException}s; however, they see a potentially older view. Compared
     ...
     * {@link RetryTransactionException}s due to read/write conflicts, however they can throw
     * {@link RetryTransactionException}s in other situations, e.g., if a leader changes occurs and the
     ...
     * fail with a {@link RetryTransactionException}) when {@link #isWaitsForLogEntryToBeCommitted} is true.
