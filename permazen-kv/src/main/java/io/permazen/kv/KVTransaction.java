...
public interface KVTransaction extends KVStore {
     ...
     * {@link io.permazen.JTransaction#getKey(io.permazen.JObject, String) JTransaction.getKey()}).
     *
     * <p>
     ...
     * @see io.permazen.io.permazen.JTransaction#getKey(io.permazen.JObject, String) JTransaction.getKey()
     */
