...
class Index2View<V1, V2, T> extends AbstractIndexView {
     ...
     */
    public Index2View(int storageId, FieldType<V1> value1Type, FieldType<V2> value2Type, FieldType<T> targetType) {
     ...
     * @throws IllegalArgumentException if any parameter is null is null or empty
     */
    public Index2View(byte[] prefix, boolean prefixMode,
