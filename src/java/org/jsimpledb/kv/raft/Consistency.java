...
public enum Consistency {
     ...
     * actually get committed. This can happen, e.g., if there is a Raft leadership change during the transaction.
     *
     * <p>
     ...
     * {@link org.jsimpledb.kv.RetryTransactionException}s; in fact, read-only transactions are equivalent to invoking
